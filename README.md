...
* 📶 Internet connection (for external images and links)
...
* CSS
* JavaScript
* External Image URLs (for exercise visuals)
* External Link (Healthline article)
...
* 🖼 Public Image Sources – Exercise visuals

* 📚 Healthline – Exercise benefits reference
